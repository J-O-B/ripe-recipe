...
!function(e){
    e.fn.pagination=function(a){
        function t(t){
            let s= e("."+r.contents+".current").children().length,
        ...
        let c=t;0==t?(c=parseInt(e("#page-navi li a.current").html()))-1!=0&&c--:t==l+1&&(c=parseInt(e("#page-navi li a.current").html()))+1!=l+1&&c++,t=c,0==s&&(o=""),
        e("#page-navi").remove(),
        ...
        c==l&&e("#page-navi li a.next").addClass("disable");let u=a.items*(t-1),
        d=a.items*t;t==l&&(d=s),e("."+r.contents+".current").children().hide(),
        e("."+r.contents+".current").children().slice(u,d).fadeIn(a.time),
        1==r.scroll&&e("html,body").animate({scrollTop:n},0)}let r={items:5,
            contents:"contents",previous:"Previous&raquo;",next:"&laquo;Next",
            time:800,
            start:1,
            position:"bottom",
            scroll:!0},
